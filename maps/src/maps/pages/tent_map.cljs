   ...
   [(reagent/create-class
      {:reagent-render         #(vector :div)
       :component-did-mount    #(do (compare-and-set! maps/active-maps 0 1)
                                    (maps/evolution! points pause maps/tent-map 0.953293 maps/active-maps))
